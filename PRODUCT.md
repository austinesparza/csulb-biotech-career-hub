...
weekly pass takes about twenty-five minutes and must stay that short. They are
not developers, and the officer who wrote a feature will graduate.

## What makes it worth using

Every published fact carries a verifiable source. Where the posting does not
state something, the record says `Unknown` rather than guessing. A student can
...
Plain, precise, unhurried. The tone of a well-kept lab notebook.

- State what is known and what is not. "Unknown" is an acceptable answer.
- Never oversell an opportunity. Never use urgency language the source does not support.
- Address the student directly and practically: what to check, what to do next.
- No marketing adjectives. No exclamation marks. No "exciting opportunity".
- Where a rule might disqualify someone, say so early and plainly.

## What it must never do

- Publish a person without recorded consent
- Leak private officer notes, submitter contact details, GPA, transcript or
