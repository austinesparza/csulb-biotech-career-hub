...
Two distinct Summer 2027 J&J requisitions were checked against employer pages showing an Apply link on September 24, then moved to `needs_review` with `public_safe = false`: [Oncology Discovery Scientist R-099898](https://www.careers.jnj.com/en/jobs/r-099898/oncology-discovery-scientist-intern/) and [Oncology Clinical Scientist R-099892](https://www.careers.jnj.com/en/jobs/r-099892/oncology-clinical-scientist-intern/). Both accept graduate master's students in the posted text, require continued enrollment and permanent U.S. work authorization, and list November 3 as an **anticipated** close. Workday form status and individual eligibility remain unknown. R-099892 has a title/body mismatch for the officer to resolve. Their discovery lead tasks were closed as handed off; two new opportunity review tasks are open. The other 16 new discovery lead tasks remain open.
